...
def read_time_series_data(file_path, time_column='Time', percent_column='Percent'):
    ...
    try:
        ...
        print("From: ", df.columns[7], "-------- to: ", df.iloc[0,7])
        # print(df.columns[7])
        # print(df.iloc[0,7])
...
def main():
    ...
    folder_path = r'3 - 12 nrf\csv'  # Replace with your folder path
    ...
    plot_time_series(data_dict, title='Temperature time response', xlabel='Time (s)', ylabel='Percentage (%)')
