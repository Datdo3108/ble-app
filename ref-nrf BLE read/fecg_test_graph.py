...
RX_CHAR_UUID = "6e400003-b5a3-f393-e0a9-e50e24dcca9e"      # RX characteristic for notifications
...
for plot in plots:
    ...
    plot.setYRange(0, 16000000)  # Set Y range based on your data
...
def handle_rx(sender, data):
    ...
    try:
        channel_1 = np.int32(int.from_bytes(data[3:6], byteorder='big', signed=True))
        ...
        if i % update_interval == 0:
            ...
            # marker_curves[0].setData(np.array([time_deque[0], time_deque[-1]]), [-2500000, 2500000])
