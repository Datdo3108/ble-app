...
data_len = min(len(channel_2), len(channel_0), len(channel_1))
...
print("Average value Offset: ", np.average(data['GPIO offset']))
print("STD: ", np.std([data['GPIO offset']]))

print("Average value VDD: ", np.average(data['VDD']))
